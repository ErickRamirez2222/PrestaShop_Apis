...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $customerUrl = "http://localhost/prestashopWebsite/api/customers/$customerId";
    ...
    if (strpos($response, '<errors>') !== false) {
        ...
        echo 'Cliente actualizado correctamente. <a href="customer.php">Ver lista de clientes</a>';
    }
