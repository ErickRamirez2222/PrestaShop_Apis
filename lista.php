...
$apiUrl = 'http://localhost/prestashopWebsite/api/products';
...
foreach ($productsXml->products->product as $product) {
    ...
    if (isset($product->id_default_image)) {
        ...
        $imageUrl = "http://localhost/prestashopWebsite/api/images/products/$id/$imageId";
        ...
        echo "<tr>
                ...
                <td>
                    <a href='editproduct.php?id=$id'>Editar</a> | 
                    <a href='delete_producto.php?id=$id' onclick='return confirm(\"¿Estás seguro de que deseas eliminar este producto?\");'>Eliminar</a>
                </td>
            </tr>";
    }
}
...
echo "<br><a href='create_product.php'>Crear Nuevos Productos</a></br>";
