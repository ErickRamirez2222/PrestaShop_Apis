...
$apiUrl = 'http://localhost/prestashopWebsite/api/customers';
...
$detailUrl = "http://localhost/prestashopWebsite/api/customers/$customerId";
            ...
            echo "<tr>
                    ...
                    <td>$email</td>
                    <td>
                        <a href='modif_customer.php?id=$customerId'>Modificar</a> | 
                        <a href='delete_customer.php?id=$customerId'>Eliminar</a>
                    </td>
                  </tr>";
        }
    } else {
    ...
    echo "</table>";
    echo "<a href='create_customer.php'>Crear Cliente</a></br>";
